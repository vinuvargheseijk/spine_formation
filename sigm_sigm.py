...
for m in range(1,len(dos)):
   respto_clust.append(((1*(0.01*3*(dos[m])**2)/(1.5+0.01*3*(dos[m])**2)))*(1.0/np.sqrt(((40.0+15)*4)/(2*(0.05-0.08*np.log((dos[m])*0.0068))))))
   print 'rigidity, max of dos, dos',(40+0.005*np.exp(max(dos)-dos[m])), max(dos), dos[m]
